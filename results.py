...
def create_results_df():
    ...
    results_df.to_csv('D:\\Desktop\\python_code\\Sales_Forecasting\\output\\results.csv')
...
def plot_results(results_df):
    ...
    plt.savefig(f'D:\\Desktop\\python_code\\Sales_Forecasting\\output\\compare_models.png')
